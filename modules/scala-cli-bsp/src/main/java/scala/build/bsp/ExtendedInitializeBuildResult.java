...
public class ExtendedInitializeBuildResult {
    @NonNull
    ...
    @NonNull
    private ExtendedBuildServerCapabilities capabilities;

    @JsonAdapter(JsonElementTypeAdapter.Factory.class)
    private Object data;

    public ExtendedInitializeBuildResult(@NonNull final String displayName, @NonNull final String version, @NonNull final String bspVersion, @NonNull final ExtendedBuildServerCapabilities capabilities) {
    ...
    @Pure
    @NonNull
    public ExtendedBuildServerCapabilities getCapabilities() {
        return this.capabilities;
    }

    public void setCapabilities(@NonNull final ExtendedBuildServerCapabilities capabilities) {
    ...
    public boolean equals(final Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        ExtendedInitializeBuildResult other = (ExtendedInitializeBuildResult) obj;
