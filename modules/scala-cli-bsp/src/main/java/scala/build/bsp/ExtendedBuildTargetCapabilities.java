...
public class ExtendedBuildTargetCapabilities {
    @NonNull
    ...
    public ExtendedBuildTargetCapabilities() {
    ...
    public ExtendedBuildTargetCapabilities(@NonNull final Boolean canCompile, @NonNull final Boolean canTest, @NonNull final Boolean canRun) {
    ...
    public ExtendedBuildTargetCapabilities(@NonNull final Boolean canCompile, @NonNull final Boolean canTest, @NonNull final Boolean canRun, @NonNull final Boolean canDebug, @NonNull final Boolean canFormat) {
        this.canCompile = canCompile;
        this.canTest = canTest;
        this.canRun = canRun;
    ...
    public boolean equals(final Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        ExtendedBuildTargetCapabilities other = (ExtendedBuildTargetCapabilities) obj;
    ...
    public int hashCode() {
        ...
        result = prime * result + ((this.canFormat== null) ? 0 : this.canFormat.hashCode());
